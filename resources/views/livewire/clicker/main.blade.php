<div class="content-center">
    ...
    <small class="text-base font-light leading-relaxed mt-0 mb-4 text-green-800">{{ $click_power }}$ / Per click  | {{ $money_per_time }}$ / {{ $money_timer }}s</small>
    <div wire:poll.5s="auto_clicker"></div>
</div>
